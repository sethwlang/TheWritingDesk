<template>
    <div style="margin-right:auto;margin-left:auto; width: 1000px;">
        ...
        <ul>
            <li><strong style="font-weight:800">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer)
                refers to The Writing Desk, LLC, Registered Agents Inc. 6545 Market Ave. North STE 100 North Canton, OH
                44721.</li>
        
            <li><strong style="font-weight:800">Service</strong> refers to the Website.</li>
            <li><strong style="font-weight:800">You</strong> means the individual accessing the Service, or the company, or other legal entity on
            behalf of which such individual is accessing or using the Service, as applicable.</li>
            <li><strong style="font-weight:800">Website</strong> refers to The writing Desk, accessible from <a style="text-decoration: underline !important; color:blue !important" href="www.usethewritingdesk.com">www.usethewritingdesk.com</a></li>
        </ul>
        <h1>Disclaimer</h1>
