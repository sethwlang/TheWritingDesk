<template>
  <div class="home">
    <div class="grid grid-cols-2 bg-twd-blue-secondary-light">
      <div class=" pt-40 pr-20 pl-10"><p>Welcome to The Writing Desk!</p>
        ...
        <p>If any of that sounds familiar, you’re in the right place! </p></div>
      <div><img src="@/assets/images/LandingPage.jpg" width="100%" height="100px"/></div>
    </div>
        <h1 class="p-10 text-center">Writing Services</h1>
    <div class="flex flex-wrap ">
      <div class="w-full ">
        <ul class="flex mb-0 list-none flex-wrap pt-3 flex-row">
          <li class="-mb-px last:mr-0 flex-auto text-center">
            <a class="text-xl font-bold uppercase px-5 py-3 rounded block leading-normal" v-on:click="toggleTabs(1)"
               v-bind:class="{'bg-twd-blue-secondary-light': openTab !== 1, 'text-white bg-twd-grey-primary-light': openTab === 1}">
              Writing
            </a>
          </li>
          <li class="-mb-px last:mr-0 flex-auto text-center">
            <a class="text-xl font-bold uppercase px-5 py-3  rounded block leading-normal" v-on:click="toggleTabs(2)"
               v-bind:class="{'bg-twd-blue-secondary-light': openTab !== 2, 'text-white bg-twd-grey-primary-light': openTab === 2}">
              Editing
            </a>
          </li>
          <li class="-mb-px last:mr-0 flex-auto text-center">
            <a class="text-xl font-bold uppercase px-5 py-3 rounded block leading-normal" v-on:click="toggleTabs(3)"
               v-bind:class="{'bg-twd-blue-secondary-light': openTab !== 3, 'text-white bg-twd-grey-primary-light': openTab === 3}">
              Accountability
            </a>
          </li>
        </ul>
        <div
            class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded bg-twd-blue-secondary-light">
          <div class="px-4 py-5 flex-auto">
            <div class="tab-content tab-space">
              <div v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
                ...
                <div
                    class="bg-twd-grey-primary-light text-white pt-2 pb-2 pl-5 pr-5 rounded-full mt-5 mb-5 mr-auto ml-auto w-32 flex items-center justify-center">
              ...
              <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
                <div class="flex items-center justify-center ">
                  Looking for additional support in setting—and reaching—your writing goals? My accountability program
                  is for you.
                </div>
                <div
                    class="bg-twd-grey-primary-light text-white pt-2 pb-2 pl-5 pr-5 rounded-full mt-5 mb-5 mr-auto ml-auto w-32 flex items-center justify-center">
    ...
    <div class="grid grid-cols-2 mr-28 ml-28 mb-10">
      <div id="signup">
      ...
      <div id="testimonies">
        <div
            class="p-5 text-center bg-twd-blue-primary rounded-r-2xl rounded-tl-2xl h-52 flex items-center justify-center mb-14 mt-14">
          “Bailey has been an key part of refining our website copy, creating several key product announcements, and
          creating concise user-help guides”.<br/>— Sara Blackstock - East Hartford, CT
        </div>
        <div
            class="p-5 text-center bg-twd-grey-primary-light text-white rounded-r-2xl rounded-tl-2xl h-52 flex items-center justify-center mb-14">
        ...
        <div
            class="p-5 text-center bg-twd-blue-primary rounded-r-2xl rounded-tl-2xl h-52 flex items-center justify-center">
          ...
          trained to help you and who has also been there and gets it.” <br/>—Milena Velez, Chapin, SC
        </div>
      </div>
