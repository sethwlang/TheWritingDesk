<template>
  <div class="unstuck">
    ...
    <div class="text-content paddington  ">
      ...
      <p>You want your writing process to feel less like pulling teeth and more like a dance with your imagination. </p>
    ...
    <div class="paddington bg-primary-light ">
      ...
      <p>You’ll learn:</p>
      <ul class="list-disc ml-5">
        <li>New writing habits that are based on cutting-edge research: We’ll work together to create a new writing life.
        </li>
        ...
        <li>How to analyze and adjust your new habits: Life happens! You’ll know how to tweak your habits to fit changes
          to
      ...
      <ul class="list-disc ml-5">
        ...
        <li>Access to me between sessions. We’ll meet live, but writing questions can pop up anytime. You can contact me
      ...
      <p>Conventional wisdom tells me I need to repeat the information above four or five times before I tell you what the
        program costs,
        but who has the time to spend an hour scrolling? Let’s get down to brass tacks. </p>

      <p>The Get Unstuck coaching program costs $2,700. You can pay in full or through six monthly payments of $450. </p>
      ...
      <p>If you have questions about Get Unstuck, let me know! You can <a
          href="https://calendly.com/the-writing-desk/free-consultation" target="_blank">set up a meeting</a> or email me
