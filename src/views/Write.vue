<template>
  <div class="write ml-28 mr-28">
    <h1>Writing Services</h1>
    <div class="grid grid-cols-2 flex items-center">
      <div >
        <img src="@/assets/images/typing.jpg" width="80%"/>
      </div>
      <div class="grid-cols-1 text-2xl">
        <p>I founded The Writing Desk to help businesses and writers make an impact, and my writing services will help you do just that.</p><br/>
    ...
    <p>You already know that good writing is essential to your business—you need copy that converts, emails that get
      ...
      collateral, email campaigns, website copy, press releases, and more.</p><br/>
    ...
    <p>Before you know it, I’ll feel like another member of the team.</p><br/>
...
<div class="grid grid-cols-2">
  <div>
    ...
    <p>If your sales team is overwhelmed by trying to sell and respond to RFPs, it’s time to offload some of that
      burden—let your team focus on what they do best, and let me handle the rest.</p><br/>
    ...
    <p>Few things are more expensive than losing out on a great opportunity because of missed deadlines or requirements!
      ...
      RFP content that you can use for years to come.</p><br/>
  ...
  <div class="pb-5 pl-5"><img src="@/assets/images/writing2.jpg" width="600px"/></div>
</div>



    <p><i>"Bailey is very proficient at creating content, word-smithing, and refining details. She also was a pleasure
    ...
    <p>Publishing an eBook can be a great way to drive interest in your business or tell a story you’re passionate
      about. Writing the book itself, however, can be a bit more challenging. That’s where I come in.</p><br/>

    <p>Whether you have a draft, an outline, or a list of ideas on a sticky note, I can help you write your book.</p><br/>
    ...
    <p>My background in writing includes everything from academic research to lead magnet eBooks and beyond. You also
      ...
      collaborative process, and you can have as much or as little engagement with the writing process as you want.</p><br/>
