      ...
      <div class="flex vertical center content">
        <div class="text-content">
          ...
          <p >When you’re thinking about putting your work out into the world, I’ll help you develop your best ideas—and
            ...
            <p>Whether you’re working with the first draft of a book or putting the final touches in place for a 
    ...
    <section class="bg-primary-light">
      <div class="text-content">
        ...
        <p>Choosing developmental editing means you’ll get a professional editorial perspective on your manuscript 
          along with specific, actionable feedback. Developmental editing provides insight into big-picture items 
    ...
    <section class="flex columns editing-proofreading">
      ...
      <div class="content">
       ...
       <p>Copyediting emphasizes technical considerations like grammar, spelling, punctuation, and sentence structure. 
        ...
        Chicago style, I’ll make sure your project adheres to those guidelines.</p>
...
export default {
  ...
  data() {
    return {
      ...
      {id: 5, title:"What Do You Really Own in the Ownership Economy?", img:"",url:"https://www.coindesk.com/layer2/2022/11/22/what-do-you-really-own-in-the-ownership-economy/"},
      ],
      settings: {
          arrows: false,
          autoplay: true,
