<template>
  <div class="edit ml-28 mr-28">
    ...
    <div class="grid grid-cols-2 flex items-center">
      <div><img src="@/assets/images/writing.jpg" width="80%"/></div>
      <div><p>Nothing will bring me more joy than helping you get your writing from draft to done! I provide editing and
    ...
    <div><h2>Developmental Editing</h2>
      ...
      <p>Developmental editing provides insight into big-picture items like pacing, dialogue, and structure. You get a
        professional editorial perspective on your manuscript, along with specific, actionable feedback.</p>
      ...
      <p>You’ve put an incredible amount of work into finishing your draft, and it’s ready for some expert insight. I
        ...
        fiction, nonfiction, and academic writers.</p>
    ...
    <div><h2>Line Editing, Copy Editing, and Proofreading</h2>
      <p>Developmental editing helps you identify big-picture items for revision, but doesn’t focus on style, technical
      ...
      <p>Spell check and grammar check are useful tools, but they’re still no match for a human editor who understands
        context—as well as how, when, and why to break the rules.</p>

      <p>I offer the following editing services for manuscripts, website copy, marketing collateral, and any other
        writing projects you’re working on:</p>
      <h3>Line Editing</h3>

      <p>While line editing, I focus on content, style, and language use. Line editing helps identify overused phrases,
        inconsistencies in style, and other issues to ensure your project is readable and accessible.</p>
      ...
      <p>The cost of putting poorly edited work out into the world is astronomical—investing in edits ahead of time
        saves time, money, and embarrassment. Contact me [link] to get started!</p>
      ...
      <p><i>"I couldn't be more pleased to work with Bailey! She's an amazing editor—really knows her stuff and also so
        ...
        amazing find"—Mish S., Cookbook Author.</i></p>
